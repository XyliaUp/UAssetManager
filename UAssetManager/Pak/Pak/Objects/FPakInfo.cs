...
public class FPakInfo
{
    ...
    public FPakInfo()
    {
        ...
        EncryptedIndex = true;
        Version = EPakFileVersion.PakFile_Version_FrozenIndex;
        Magic = PAK_FILE_MAGIC;
    }
    ...
    {
        // New FPakInfo fields.
        writer.Write(EncryptionKeyGuid);
        ...
        else
        {
            ...
            foreach (var method in CompressionMethods.Where(o => o != CompressionMethod.None))
