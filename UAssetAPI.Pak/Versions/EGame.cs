...
namespace UAssetAPI.Pak.Versions;
public enum EGame
{
    ...
    GAME_UE4_25 = GameUtils.GameUe4Base + 25 << 4,
        ...
        GAME_BladeAndSoul = GAME_UE4_25 + 10,
    GAME_UE4_26 = GameUtils.GameUe4Base + 26 << 4,
        GAME_GTATheTrilogyDefinitiveEdition = GAME_UE4_26 + 1,
        GAME_ReadyOrNot = GAME_UE4_26 + 2,
        GAME_TowerOfFantasy = GAME_UE4_26 + 3,
        GAME_FinalFantasy7Rebirth = GAME_UE4_26 + 4,
        GAME_TheDivisionResurgence = GAME_UE4_26 + 5,
        GAME_StarWarsJediSurvivor = GAME_UE4_26 + 6,
        GAME_Snowbreak = GAME_UE4_26 + 7,
        GAME_TorchlightInfinite = GAME_UE4_26 + 8,
        GAME_QQ = GAME_UE4_26 + 9,
        GAME_WutheringWaves = GAME_UE4_26 + 10,
        GAME_DreamStar = GAME_UE4_26 + 11,
        GAME_MidnightSuns = GAME_UE4_26 + 12,
        GAME_FragPunk = GAME_UE4_26 + 13,
        GAME_RacingMaster = GAME_UE4_26 + 14,
    ...
    // UE5 Early Access versions (pre-5.0.0)
    ...
    GAME_UE5_EARLY_ACCESS = GameUtils.GameUe5Base - 1,
