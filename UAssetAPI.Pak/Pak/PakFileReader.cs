...
using static UAssetAPI.Pak.Compression.Compression;
using static UAssetAPI.Pak.Objects.EPakFileVersion;

namespace UAssetAPI.Pak.Pak;
public partial class PakFileReader : AbstractAesVfsReader
{
    ...
    public PakFileReader(string key) : base("", new() { Game = EGame.GAME_BladeAndSoul })
    {
        AesKey = new FAesKey(key);
        Info = new FPakInfo();
    }
