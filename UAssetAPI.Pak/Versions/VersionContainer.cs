...
public class VersionContainer : ICloneable
{
	...
	public VersionContainer(EGame game = GAME_UE4_LATEST, FPackageFileVersion ver = default, IDictionary<string, bool>? optionOverrides = null, IDictionary<string, KeyValuePair<string, string>>? mapStructTypesOverrides = null)
	{
	...
	public object Clone() => new VersionContainer(Game, Ver, _optionOverrides, _mapStructTypesOverrides) { bExplicitVer = bExplicitVer };
}
