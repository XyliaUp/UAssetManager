...
public partial class MainWindow : Window
{
	...
	private void DataGrid_CellEditEnding(object sender, DataGridCellEditEndingEventArgs e)
	{
		...
		{
			MessageBox.Show(StringHelper.Get("MainWindow_CellEditErrorMessage", ex.Message), StringHelper.Get("Text.Error"), MessageBoxButton.OK, MessageBoxImage.Error);
	...
	private void DataGrid_RowEditEnding(object sender, DataGridRowEditEndingEventArgs e)
	{
		...
		{
			MessageBox.Show(StringHelper.Get("MainWindow_UpdateRowErrorMessage", ex.Message), StringHelper.Get("Text.Error"), MessageBoxButton.OK, MessageBoxImage.Error);
	...
	private void DataGrid_PreviewKeyDown(object sender, KeyEventArgs e)
	{
		if (e.Key == Key.Delete && DataGridView.SelectedItems.Count > 0)
		{
			...
			{
				MessageBox.Show(StringHelper.Get("MainWindow_DeleteItemsErrorMessage", ex.Message), StringHelper.Get("Text.Error"), MessageBoxButton.OK, MessageBoxImage.Error);
